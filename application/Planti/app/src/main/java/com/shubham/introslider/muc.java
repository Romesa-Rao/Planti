...
Button ang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setNavigationBarColor(ContextCompat.getColor(muc.this,R.color.green));
        getWindow().setStatusBarColor(ContextCompat.getColor(muc.this,R.color.green));
        ang = findViewById(R.id.angry_btn);
        ang.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view1){
                Intent myIntent = new Intent(muc.this, mud.class);
