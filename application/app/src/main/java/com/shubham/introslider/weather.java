...
public class weather extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.hide();
        getWindow().setNavigationBarColor(ContextCompat.getColor(weather.this,R.color.black));
        getWindow().setStatusBarColor(ContextCompat.getColor(weather.this,R.color.black));
