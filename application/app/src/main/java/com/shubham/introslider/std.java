...
public class std extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setNavigationBarColor(ContextCompat.getColor(std.this,R.color.green));
        getWindow().setStatusBarColor(ContextCompat.getColor(std.this,R.color.green));
        angr = findViewById(R.id.angry_btnn);
        angr.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view1){
                Intent myIntent = new Intent(std.this, stc.class);
