package com.shubham.introslider.ml;
...
public final class AutoModel1 {
  @NonNull
  private final Model model;

  private AutoModel1(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "1.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static AutoModel1 newInstance(@NonNull Context context) throws IOException {
    return new AutoModel1(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static AutoModel1 newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new AutoModel1(context, options);
  }
